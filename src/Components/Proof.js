...
const Proof = () => {
  return (
    <div id='main' className='w-screen h-[1530px] absolute flex flex-col lg:flex-row'>
        ...
        <div className='flex flex-col w-[327px] h-[266px] mx-auto lg:ml[745px] lg:mt[145px]'>
            ...
            <div className='flex flex-col w-[327px] h-[78px] bg-[#F7F2F7] rounded-lg mt-[16px]'> 
                <div className='flex flex-row mx-auto mt-[16px]'>
                    <img src={stars} alt=''  className='w-[16.55px] h-[15.77px]'></img>
                    <img src={stars} alt='' className='w-[16.55px] h-[15.77px] ml-[15px]'></img>
                    <img src={stars} alt='' className='w-[16.55px] h-[15.77px] ml-[15px]'></img>
            ...
            <div className='flex flex-col w-[327px] bg-[#512051] rounded-xl mt-[49px]'>
                ...
                <p className='text-[17px] text-white font-spartan leading-[22px] mx-[56px] mt-[23px] mb-[35px]'>“ We needed the same printed design as the one we had ordered a week prior. Not only did they find the original order, but we also received it in time. Excellent! ”</p>
            </div>
            <div className='flex flex-col w-[327px] bg-[#512051] rounded-xl mt-[16px]'>
                <div className='flex flex-row mt-[40px] ml-[56px]'>
